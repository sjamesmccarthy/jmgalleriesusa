...
jQuery(document).ready(function($){
    ...
    console.log('ToolBarButtonCount: ' + $("div[class*='actions'] button").length)
    ...
    $("div[class*='actions'] button").on("click", function(e) {
        ...
        if (action) {
                ...
                console.log('Writing HTML to RAW view');
                /* Strip out SPAN tags for Webkit UL and OL bug */
                var stripSpanHTML = $(".content_html").html();
                stripSpanHTML = stripSpanHTML.replace(/<\/?span[^>]*>/g,"");
                $('.content_raw').val( stripSpanHTML );
        } else {
