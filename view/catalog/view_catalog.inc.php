...
/* component_gallery_thumbs.php, component_new_releases.php, view_catalog.inc.php */
    ...
    switch($catalog_meta[0]['path']) {
        ...
        case "alignment":
            $catalog_photos = $this->api_Catalog_vcAlignment();
            break;

        case "new-releases":
            $catalog_photos = $this->api_Catalog_Get_New_Releases($new_release_data[0], $new_release_data[1]);
        ...
        default:
            // ALL PHOTOS of specified collection path
            $catalog_tabs_hidden = false;
            $catalog_le_desc = $catalog_meta[0]['title'];
    ...
    if( !$catalog_photos['error']) {
        ...
        $thumb_html = "<div id='error' class='col-12 color-error'><p class='text-center tiny'>stark:+19008720101:begin_transmission</p><p class='text-center'>Somebody notify Captain Marvel. Thanos has turned our results to dust.</p>
