...
?>
            ...
            <input type="email" value="" placeholder="ENTER YOUR EMAIL (eg, john@gmail.com)" name="EMAIL" class="newsletterinput required email" id="mce-EMAIL" style="width:58% !important;">
            ...
            <div style="display: inline-block"><button type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button newsletter-button">SIGN-UP</button></div>
            </form>
<?php
    // } 
?>