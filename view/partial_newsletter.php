...
<div id="mc_embed_signup">
    <form action="https://jmgalleries.us16.list-manage.com/subscribe/post?u=7fe25703399796912d1b5d6f8&amp;id=a869c7c419" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
        <div id="mc_embed_signup_scroll">
            <input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="TYPE YOUR EMAIL ADDRESS (UNSUBSCRIBE ANYTIME)">
    ...
    <!-- <p class="small">Be the first to know about new releases, pop-up gallery events and exhibits, as well as new additions to our website and other news.</p> -->
  </div>
</form>
</div>
