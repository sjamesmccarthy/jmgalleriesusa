...
// $this->console('loaded.Fieldnotes.Inc');
...
/* Check for image */
if($res_type == "article") {
    if ( is_file($_SERVER['DOCUMENT_ROOT'] . "/view/__image/fieldnotes/" . $res_image ) ) {
        $img_html = '<div class="col image filmstrip--carousel">
        <img src="/view/__image/fieldnotes/' . $res_image . '"  alt="' . $res_image . '" /><br />
           ...
           $res_content .= '
                <div id="img_' . $j . '_wrapper" class="grid">
                    ...
                    <div class="col-12_sm-12" style="position: relative;">
                        <img id="img_' . $j . '_photo" style="width: 100%; border-radius: 6px;" src="/view/__image/fieldnotes/' . $imgV['path'] . '" alt="' . $imgV['path'] . '" />' . $add_url . '
                    </div>
