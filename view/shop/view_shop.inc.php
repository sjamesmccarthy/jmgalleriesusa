...
if(!$product_data['error']) {
    ...
    $thumb_html .= '<div class="col-12 pt-32"><p class="shop-nothing-found">Oh no, how embarassing<br/>our shelves seem to be a bit bare today.<br />Please check back later.</p></div>';
}
