        ...
        <div class="grid-4_sm-2 grid-4_md-3">
            ...
            <div class="col-12">
                ...
                <div id="form_referrCollectorForm_container" class="mt-32">
                    ...
                    <input type="hidden" id="promo_code" name="promo_code" value="strtoupper({$this->collector_data_obj->last_name}) {$this->collector_data_obj->collector_id} " />
