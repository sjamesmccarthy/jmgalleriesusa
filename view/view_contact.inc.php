...
if(isSet($this->data->routePathQuery[0])) {
    ...
    $message_PH = "PLEASE TELL US A LITTLE BIT MORE ABOUT YOUR PURCHASE. <ul class='contact-ul'><li>Edition: Gallery or Studio</li><li>Size: 16x24, 20x30, 24x36, etc.</li><li>Frame: Yes / No</li><li>Ship (Provide Postal Code) or Pickup (Las Vegas, Nevada)</li><li>Phone Number, An art consultant will contact you within 24 hours to complete this order</li></ul>";
