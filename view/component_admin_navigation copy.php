...
<div class="col-2 navigation--container">
            ...
            <div class="toolbox">
                ...
                <li class="collections collections-add"><a href="/studio/collections">Web Collection Manager</a><p class="add-icon-nav"><a href="/studio/collections-add"><i class="fas fa-plus-circle"></i></a></p></li>
                </ul>
            </div>
