...
if($this->routes->URI->page == 'detail') {
    ...
    if($this->page->edition == 'tinyviews') {
        $bc_catalog = '<img class="breadcrumb-arrow" src="/view/image/icon_navarrow-right.svg" alt="right-arrow" /> <a href="/shop"/>jM Gallery Store</a> <img class="breadcrumb-arrow" src="/view/image/icon_navarrow-right.svg" alt="breadcrumb-icon" /><a href="/open-editions">Open Editions</a>';
    } else {
