...
if(isSet($this->routes->URI->queryvals)) {
    ...
    if( $image_data[0] != 'NaN') {
        ...
        // $res_image = null;
        // $res_image = $res_image;
        if ( file_exists($_SERVER["DOCUMENT_ROOT"] . "/view/__image/fieldnotes/" . $res_image) ) {
            $imgsLoaded = 1; 
        } 
    }
    ...
    if($res_image != '') {
        $show_image1_html = '<div class="show-image-container"><img src="/view/__image/fieldnotes/' . $res_image . '" class="show-image" alt="' . $res_image . '" /></div>';
    ...
    if(isSet($res_image_2)) {
        $show_image2_html = '<div class="show-image-container"><img src="/view/__image/fieldnotes/' . $res_image_2 . '" class="show-image" alt="' . $res_image_2 . '" /></div>';
    } else {
    ...
    if(isSet($res_image_3)) {
        $show_image3_html = '<div class="show-image-container"><img src="/view/__image/fieldnotes/' . $res_image_3 . '" class="show-image" alt="' . $res_image_3 . '"  /></div>';
    } else {
    ...
    if(isSet($res_image_4)) {
        $show_image4_html = '<div class="show-image-container"><img src="/view/__image/fieldnotes/' . $res_image_4 . '" class="show-image" alt="' . $res_image_4 . '" /></div>';
    } else {
    ...
    if(isSet($res_image_5)) {
        $show_image5_html = '<div class="show-image-container"><img src="/view/__image/fieldnotes/' . $res_image_5 . '" class="show-image" alt="' . $res_image_5 . '" /></div>';
    } else {
    ...
    if(isSet($res_image_6)) {
        $show_image6_html = '<div class="show-image-container"><img src="/view/__image/fieldnotes/' . $res_image_6 . '" class="show-image" alt="' . $res_image_6 . '" /></div>';
    } else {
    ...
    $image_info = "<span class='file--image_info'>CURRENT IMAGE FILE /view/__image/fieldnotes/" . $res_image . "</span>";
