...
if(isSet($this->routes->URI->queryvals)) {
    ...
    foreach ($image_data as $iK => $iV) {
        ...
        if ( $iV['size'] != "0" || is_file($_SERVER["DOCUMENT_ROOT"] . "/view/__image/product/" . $iV['name'])) {
    ...
    if ( is_file($_SERVER["DOCUMENT_ROOT"] . "/view/__image/product/" . $res_uri_path . '_thumb.jpg') ) {
        $res_image_6 = $res_uri_path . '_thumb.jpg';
    }
        
    if(isSet($res_image_1)) {
        $show_image1_html = '<div class="show-image-container"><img src="/view/__image/product/' . $res_image_1 . '" class="show-image" alt="' . $res_image_1 . '" /></div>';
        $image_info_1 = "<span class='file--image_info'>CURRENT IMAGE FILE /view/__image/product/" . $res_image_1 . "</span>";   
    } else {
    ...
    if(isSet($res_image_2)) {
        $show_image2_html = '<div class="show-image-container"><img src="/view/__image/product/' . $res_image_2 . '" class="show-image" alt="' . $res_image_2 . '" /></div>';
        $image_info_2 = "<span class='file--image_info'>CURRENT IMAGE FILE /view/__image/product/" . $res_image_2 . "</span>";
    } else {
    ...
    if(isSet($res_image_3)) {
        $show_image3_html = '<div class="show-image-container"><img src="/view/__image/product/' . $res_image_3 . '" class="show-image" alt="' . $res_image_3 . '"  /></div>';
        $image_info_3 = "<span class='file--image_info'>CURRENT IMAGE FILE /view/__image/product/" . $res_image_3 . "</span>";
    } else {
    ...
    if(isSet($res_image_4)) {
        $show_image4_html = '<div class="show-image-container"><img src="/view/__image/product/' . $res_image_4 . '" class="show-image" alt="' . $res_image_4 . '" /></div>';
        $image_info_4 = "<span class='file--image_info'>CURRENT IMAGE FILE /view/__image/product/" . $res_image_4 . "</span>";
    } else {
    ...
    if(isSet($res_image_5)) {
        $show_image5_html = '<div class="show-image-container"><img src="/view/__image/product/' . $res_image_5 . '" class="show-image" alt="' . $res_image_5 . '" /></div>';
        $image_info_5 = "<span class='file--image_info'>CURRENT IMAGE FILE /view/__image/product/" . $res_image_5 . "</span>";
    } else {
    ...
    if(isSet($res_image_6)) {
        $show_image6_html = '<div class="show-image-container"><img src="/view/__image/product/' . $res_image_6 . '" class="show-image" alt="' . $res_image_6 . '" /></div>';
        $image_info_6 = "<span class='file--image_info'>CURRENT IMAGE FILE /view/__image/product/" . $res_image_6 . "</span>";
    } else {
    ...
    $image_info = "<span class='file--image_info'>CURRENT IMAGE FILE /view/__image/product/" . $res_image_1 . "</span>";
