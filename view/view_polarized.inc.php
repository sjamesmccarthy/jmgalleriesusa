        ...
        ';
            ...
            $card_html .= '
                <div class="col-6_sm-12 storycard--background" style="background-color: #000;">
                    <div style="border-radius: 6px; padding: 5px;padding-left: 2rem; background-color: rgba(0, 0, 0, 0.5);padding-top: 1rem;">
                    ...
                    <div class="content--preview" style="display: flex; justify-content: center;">                        
                    <!-- HTML for images -->' . $strip_html . 
                    '</div>
                    <div id="content--teaser"><p style="padding: 1rem;color:#FFF;">' . $value['teaser'] . '</p></div> 
