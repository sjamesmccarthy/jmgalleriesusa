...
<section id="release-notes">
    <div class="grid-center">
        ...
        <p class="pt-16">v1.9.1<br />April 26, 2022</p>
            ...
            <li>update: catalog sync, GA4</li>
            <li>update: moved code base to PHP 8.0.8, updated database</li>
            <li>bugfix: reports, fieldnotes in admin</li>
            <li>updates: misc style changes to navbar</li>
            </ul>
        </p>
        ...
        <p class="pt-16">v1.3.1<br />May 8, 2020</p>
        	<ul>
        	...
        	<li>new: Release Notes page</li>
        	<li>bugfix: margin/padding issues in admin headlines.</li>
        	</ul>
        </p>

        <p class="pt-16">v1.3.0<br />May 4, 2020</p>
        	<ul>
        	<li>new: integrated config file into admin area.</li>
        	<li>bugfix: header, footer formatting on tablet.</li>
        	<li>bugfix: Miscellaneous updates to CSS/styles.</li>
        	<li>new: added workflow in admin area to process orders.</li>
        	</ul>
        </p>

        <p class="pt-16">v1.2.0<br />April 17, 2020</p>
        	<ul>
        	<li>Launched portal for collectors to login and manage their collections, as well as acquire exclusive artwork.</li>
        	</ul>
        </p>

        <p class="pt-16">v1.1.0<br />November 27, 2019</p>
        	<ul>
        	<li>Launched new admin area to control site releases, inventory, etc.</li>
        	</ul>
        </p>
